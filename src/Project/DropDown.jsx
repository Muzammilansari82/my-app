...
"
      ...
      <div className="dropdown-container">
        <button className="dropdown-button" style={{marginLeft:"-315px", marginTop: "25px"}} onClick={handleToggle1}>
          Features
        </button>
        {isOpen1 && (
          <div className="dropdown-content">
      ...
      <div className="dropdown-container"><br />
        <button className="dropdown-button" style={{marginLeft:"-100px"}} onClick={handleToggle2}>
      Resources
        </button>
        {isOpen2 && (
          <div className="dropdown-content">
